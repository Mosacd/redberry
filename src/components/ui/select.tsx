...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "group cursor-pointer flex w-fit bg-[#FFFFFF] border-[#CED4DA] data-[state=open]:border-b-[white] data-[state=open]:rounded-b-[0px] items-center justify-between whitespace-nowrap disabled:cursor-not-allowed disabled:opacity-50 outline-none focus:outline-none focus-visible:outline-none",
        className
      )}
      {...props}
    >
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative text-[14px] leading-[100%] font-[300] flex justify-start w-full cursor-pointer items-center outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 h-[45px] p-[14px] pl-[11px]",
