...
const GeneralTaskPage = () => {
  ...
  const [appliedDepartments, setAppliedDepartments] = useState<string[]>(
    () => getArrayFromParams("departments") || []
  );
  const [appliedPriorities, setAppliedPriorities] = useState<string[]>(
    () => getArrayFromParams("priorities") || []
  );
  const [appliedEmployee, setAppliedEmployee] = useState<string | null>(() =>
    getStringFromParams("employee")
  );
  ...
  return (
    <>
      <div className="px-[118px]">
        <h1 className="font-[FiraGO] leading-[100%] font-[600] text-[34px] mt-[40px] mb-[52px] tracking-[0] text-[#212529]">
          დავალებების გვერდი
        </h1>
        <CustomSelect
          ...
          setAppliedDepartments={setAppliedDepartments}
          setAppliedPriorities={setAppliedPriorities}
          setAppliedEmployee={setAppliedEmployee}
        />
