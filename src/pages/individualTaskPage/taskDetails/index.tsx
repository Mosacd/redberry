...
const TaskDetails:React.FC <{changeStatus:(id: number, statusId: number) => void , status:Status[] | undefined, task:Task, taskId:number}> = ({changeStatus,status,task,taskId}) => {
